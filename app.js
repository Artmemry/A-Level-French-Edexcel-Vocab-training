...
/*T-START*/
const T={
  flagTitle:"Tu as signalé des réponses", flagLede:"Ton professeur les verra dans ton code de suivi.",
  flagSend:"Prévenir mon professeur maintenant", flagSent:"Envoyé ✓", flagAuto:"Ton professeur a été prévenu.",
  ...
  taskAllDone:"Task of the week done ✓", clsLabel:"Classe", clsHint:"Optional. Your teacher's task link sets it for you; change it here if it is wrong.", clsAsk:"Which class are you in?", taskGo:"Voir la tâche", taskStrip:l=>"This week: "+l,
  progressTitle:"Suivi",
